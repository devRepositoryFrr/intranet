...
export default function ModalSp() {
		...
		Axios.post('https://sistemaintegral.conavi.gob.mx:81/api/nuevo_ticket', {
			...
			(response) => {
				if (response.data != "") {
					...
					////console.log(b64toBlob(document.getElementById('f-sp1').files[0]));
					...
					enviarEmail(
						...
						/*modulo*/"Nuevo ticket",
						/*fotos*/
						$("#t-sp1").val().toString().replace("data:image/jpeg;base64,", ""),
						$("#t-sp2").val().toString().replace("data:image/jpeg;base64,", ""),
						$("#t-sp3").val().toString().replace("data:image/jpeg;base64,", ""),
						$("#t-sp4").val().toString().replace("data:image/jpeg;base64,", ""),
						$("#t-sp5").val().toString().replace("data:image/jpeg;base64,", ""));
	...
	const enviarEmail = (aplicativo, cuerpo, asunto, mensaje, modulo, img1, img2, img3, img4, img5) => {
		Axios.post("https://sistemaintegral.conavi.gob.mx:81/api/send_mail", {
			// Axios.post("http://localhost:3001/api/send_mail", {
			aplicativo,
			cuerpo,
			asunto,
			mensaje,
			...
			<div class='modal-body' style={{ height: 450, overflowX: "auto", overflowY: "auto" , padding: 20 }}>
				...
				<div>
					<div id="d-sp1" class="file-select hidden">
						...
						<input class="files_" accept="image/jpg" id="f-sp1" type="file" style={{ display: "none" }}></input>
					...
					<div id="d-sp2" class="file-select hidden">
						...
						<input class="files_" accept="image/jpg" id="f-sp2" type="file" style={{ display: "none" }}></input>
					...
					<div id="d-sp3" class="file-select hidden">
						...
						<input class="files_" accept="image/jpg" id="f-sp3" type="file" style={{ display: "none" }}></input>
					...
					<div id="d-sp4" class="file-select hidden">
						...
						<input class="files_" accept="image/jpg" id="f-sp4" type="file" style={{ display: "none" }}></input>
					...
					<div id="d-sp5" class="file-select hidden">
						...
						<input class="files_" accept="image/jpg" id="f-sp5" type="file" style={{ display: "none" }}></input>
