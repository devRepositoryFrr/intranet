...
const consultar = () => {
	...
	$.getJSON("https://sistemaintegral.conavi.gob.mx:81/api/doc_igsu", function (data) {
		//console.log(data);
		$.each(data, function (key, val_) {
			if (val_.grupo == "link") {
				$("#cont-files").append(

					'<a href="https://sistemaintegral.conavi.gob.mx:81/int/igualdad_sustantiva/' + val_.ruta + '" target="_blank"><div class="col-md-3 top-buffer-x15">' +
					'<div class="card">' +
					val_.ic +
...
function IgualdadSustantiva(props) {
			...
			<header>
				...
				<div id="cont" class="container">
					...
					<ol id="bread" class="breadcrumb">
						...
						<li class="active"><Link class="nav-link">IgualdadSustantiva</Link></li>
					</ol>
...
export default IgualdadSustantiva;